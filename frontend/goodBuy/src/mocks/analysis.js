const MOCK_TRANSACTIONS = [
  ['세븐일레븐 광주산정고려점', 16480, 'EXPENSE', 'FOOD', false, 'NONE', null],
  ['세븐일레븐광주소촌이지점', 2750, 'EXPENSE', 'FOOD', false, 'NONE', null],
  ['버거앤타코', 11600, 'EXPENSE', 'FOOD', false, 'NONE', null],
  ['벌크커피하남소촌점', 3000, 'EXPENSE', 'FOOD', false, 'NONE', null],
  ['맘스터치소촌점', 7900, 'EXPENSE', 'FOOD', false, 'NONE', null],
  ['금호칼국수', 7500, 'EXPENSE', 'FOOD', false, 'NONE', null],
  [
    '토스페이_TOSS',
    630,
    'ANOMALY',
  ...
  ['다이소', 6000, 'EXPENSE', 'LIVING', false, 'NONE', null],
  ['389마트', 1200, 'EXPENSE', 'LIVING', false, 'NONE', null],
]
